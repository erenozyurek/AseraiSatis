...
const faq = [
  {
    q: 'Aserai ve Iberai’yi ayrı ayrı alabilir miyim?',
    a: 'Evet. İki ürünü bağımsız paketler olarak satın alabilir ya da birlikte avantajlı paket fiyatından yararlanabilirsiniz.',
  },
  {
    ...
    <>
      ...
      <section className="section pak-plans">
        <div className="container">
          <PricingPlans
            productKeys={['aserai', 'iberai', 'paket']}
            showTabs
          />
        </div>
      </section>
