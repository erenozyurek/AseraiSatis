...
| Yönetim Paneli | 🟡 ~%65 | Dashboard/Sipariş/Destek/Paket/Modül/Yenileme/Müşteri/**Bildirim** + inline ✅ · sekme akıcılığı/hover düzeltmeleri ✅ · Ödeme/API/CMS/Ayarlar/Roller ❌ |
...
| O. API Yönetimi | 🔴 | — |
| P. İçerik (CMS) | 🟡 | Modüller + Özellikler inline ✅ · kart görsel URL/storage desteği ✅ · Blog/Hukuki statik ❌ |
| Q. Sistem Ayarları | 🔴 | — |
...
1. **Ödeme Entegrasyonu (K)** — PayTR/İyzico Edge Function webhook → sipariş/modül siparişi `paid` otomatikleşsin.
...
4. **CMS (P)** — Blog/Hukuki içeriğini de DB/inline'a taşımak.
